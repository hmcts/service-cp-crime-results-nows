# NEE DetentionOnRecommendationForDeportation

- **Template ID:** `NEE_DetentionOnRecommendationForDeportation`
- **Source file:** `analysis/templates/NEE_DetentionOnRecommendationForDeportationTemplate.docx`
- **Type:** Notice
- **Delivery:** Email
- **Language:** English
- **Code:** `NEE`
