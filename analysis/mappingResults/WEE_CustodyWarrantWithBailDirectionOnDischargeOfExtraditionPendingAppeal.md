# WEE CustodyWarrantWithBailDirectionOnDischargeOfExtraditionPendingAppeal

- **Template ID:** `WEE_CustodyWarrantWithBailDirectionOnDischargeOfExtraditionPendingAppeal`
- **Source file:** `analysis/templates/WEE_CustodyWarrantWithBailDirectionOnDischargeOfExtraditionPendingAppealTemplate.docx`
- **Type:** Warrant
- **Delivery:** Email
- **Language:** English
- **Code:** `WEE`
