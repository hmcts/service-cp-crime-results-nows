# WEE CustodyWarrantWithBailDirectionSendingToSecretaryOfStateCategory2Territory

- **Template ID:** `WEE_CustodyWarrantWithBailDirectionSendingToSecretaryOfStateCategory2Territory`
- **Source file:** `analysis/templates/WEE_CustodyWarrantWithBailDirectionSendingToSecretaryOfStateCategory2TerritoryTemplate.docx`
- **Type:** Warrant
- **Delivery:** Email
- **Language:** English
- **Code:** `WEE`
