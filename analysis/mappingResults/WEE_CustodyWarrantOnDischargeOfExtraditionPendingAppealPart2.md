# WEE CustodyWarrantOnDischargeOfExtraditionPendingAppealPart2

- **Template ID:** `WEE_CustodyWarrantOnDischargeOfExtraditionPendingAppealPart2`
- **Source file:** `analysis/templates/WEE_CustodyWarrantOnDischargeOfExtraditionPendingAppealPart2Template.docx`
- **Type:** Warrant
- **Delivery:** Email
- **Language:** English
- **Code:** `WEE`
