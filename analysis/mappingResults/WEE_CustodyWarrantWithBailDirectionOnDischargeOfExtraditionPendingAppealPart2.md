# WEE CustodyWarrantWithBailDirectionOnDischargeOfExtraditionPendingAppealPart2

- **Template ID:** `WEE_CustodyWarrantWithBailDirectionOnDischargeOfExtraditionPendingAppealPart2`
- **Source file:** `analysis/templates/WEE_CustodyWarrantWithBailDirectionOnDischargeOfExtraditionPendingAppealPart2Template.docx`
- **Type:** Warrant
- **Delivery:** Email
- **Language:** English
- **Code:** `WEE`
