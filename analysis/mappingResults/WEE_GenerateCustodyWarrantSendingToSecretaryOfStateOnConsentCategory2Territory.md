# WEE GenerateCustodyWarrantSendingToSecretaryOfStateOnConsentCategory2Territory

- **Template ID:** `WEE_GenerateCustodyWarrantSendingToSecretaryOfStateOnConsentCategory2Territory`
- **Source file:** `analysis/templates/WEE_GenerateCustodyWarrantSendingToSecretaryOfStateOnConsentCategory2TerritoryTemplate.docx`
- **Type:** Warrant
- **Delivery:** Email
- **Language:** English
- **Code:** `WEE`
