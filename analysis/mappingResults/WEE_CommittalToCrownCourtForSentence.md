# WEE CommittalToCrownCourtForSentence

- **Template ID:** `WEE_CommittalToCrownCourtForSentence`
- **Source file:** `analysis/templates/WEE_CommittalToCrownCourtForSentenceTemplate.docx`
- **Type:** Warrant
- **Delivery:** Email
- **Language:** English
- **Code:** `WEE`
