# WEE CustodyWarrantWithBailDirectionSendingToSecretaryOfStateOnConsentCategory2Territory

- **Template ID:** `WEE_CustodyWarrantWithBailDirectionSendingToSecretaryOfStateOnConsentCategory2Territory`
- **Source file:** `analysis/templates/WEE_CustodyWarrantWithBailDirectionSendingToSecretaryOfStateOnConsentCategory2TerritoryTemplate.docx`
- **Type:** Warrant
- **Delivery:** Email
- **Language:** English
- **Code:** `WEE`
