# WEE CustodyWarrantOnDischargeOfExtraditionPendingAppeal

- **Template ID:** `WEE_CustodyWarrantOnDischargeOfExtraditionPendingAppeal`
- **Source file:** `analysis/templates/WEE_CustodyWarrantOnDischargeOfExtraditionPendingAppealTemplate.docx`
- **Type:** Warrant
- **Delivery:** Email
- **Language:** English
- **Code:** `WEE`
