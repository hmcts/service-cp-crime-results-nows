# WEE ExtraditionSupplementToCustodyWarrant

- **Template ID:** `WEE_ExtraditionSupplementToCustodyWarrant`
- **Source file:** `analysis/templates/WEE_ExtraditionSupplementToCustodyWarrantTemplate.docx`
- **Type:** Warrant
- **Delivery:** Email
- **Language:** English
- **Code:** `WEE`
