...
class HearingRepositoryTest extends RepositoryIntegrationTestBase {
    ...
    @Transactional
    @Test
    void findById_should_returnEntity_whenMatchExists() {
        ...
        assertThat(hearingRepository.findById(HEARING_ID)).isPresent();
    }

    @Transactional
    @Test
    void findById_should_returnEmpty_whenNoMatch() {
        assertThat(hearingRepository.findById(NO_MATCH_HEARING_ID)).isEmpty();
    }
}